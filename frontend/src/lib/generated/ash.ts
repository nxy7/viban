...
export type BoardResourceSchema = {
  ...
  task_templates: { __type: "Relationship"; __array: true; __resource: TaskTemplateResourceSchema; };
};
...
export type TaskResourceSchema = {
  ...
  periodical_task: { __type: "Relationship"; __resource: PeriodicalTaskResourceSchema | null; };
...
export type PeriodicalTaskResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "title" | "description" | "schedule" | "executor" | "execution_count" | "last_executed_at" | "next_execution_at" | "enabled" | "last_created_task_id" | "board_id";
  id: UUID;
  title: string;
  description: string | null;
  schedule: string;
  executor: "claude_code" | "gemini_cli" | "codex" | "opencode" | "cursor_agent" | null;
...
// TaskTemplate Schema
export type TaskTemplateResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "name" | "description_template" | "position" | "board_id";
  id: UUID;
  name: string;
...
export type BoardFilterInput = {
  ...
  task_templates?: TaskTemplateFilterInput;
...
export type TaskTemplateFilterInput = {
  and?: Array<TaskTemplateFilterInput>;
  or?: Array<TaskTemplateFilterInput>;
  not?: Array<TaskTemplateFilterInput>;
...
export type CreatePeriodicalTaskFields = UnifiedFieldSelection<PeriodicalTaskResourceSchema>[];
...
export type CreatePeriodicalTaskResult<Fields extends CreatePeriodicalTaskFields | undefined = undefined> = | { success: true; data: InferCreatePeriodicalTaskResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function create_periodical_task<Fields extends CreatePeriodicalTaskFields | undefined = undefined>(
  config: {
...
): Promise<CreatePeriodicalTaskResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<CreatePeriodicalTaskResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
export type ListPeriodicalTasksFields = UnifiedFieldSelection<PeriodicalTaskResourceSchema>[];
...
> = ConditionalPaginatedResultMixed<Page, Array<InferResult<PeriodicalTaskResourceSchema, Fields>>, {
...
export type ListPeriodicalTasksResult<Fields extends ListPeriodicalTasksFields, Page extends ListPeriodicalTasksConfig["page"] = undefined> = | { success: true; data: InferListPeriodicalTasksResult<Fields, Page>; }
| { success: false; errors: AshRpcError[]; }

;

export async function list_periodical_tasks<Fields extends ListPeriodicalTasksFields, Config extends ListPeriodicalTasksConfig = ListPeriodicalTasksConfig>(
  config: Config & { fields: Fields }
  ...
  return executeActionRpcRequest<ListPeriodicalTasksResult<Fields, Config["page"]>>(
    payload,
    config
  );
}
...
export type GetPeriodicalTaskFields = UnifiedFieldSelection<PeriodicalTaskResourceSchema>[];
export type InferGetPeriodicalTaskResult<
  Fields extends GetPeriodicalTaskFields,
> = InferResult<PeriodicalTaskResourceSchema, Fields>;

export type GetPeriodicalTaskResult<Fields extends GetPeriodicalTaskFields> = | { success: true; data: InferGetPeriodicalTaskResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function get_periodical_task<Fields extends GetPeriodicalTaskFields>(
  config: {
  hookCtx?: ActionHookContext;
  fields: Fields;
  headers?: Record<string, string>;
...
export type UpdatePeriodicalTaskFields = UnifiedFieldSelection<PeriodicalTaskResourceSchema>[];

export type InferUpdatePeriodicalTaskResult<
  Fields extends UpdatePeriodicalTaskFields | undefined,
> = InferResult<PeriodicalTaskResourceSchema, Fields>;

export type UpdatePeriodicalTaskResult<Fields extends UpdatePeriodicalTaskFields | undefined = undefined> = | { success: true; data: InferUpdatePeriodicalTaskResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function update_periodical_task<Fields extends UpdatePeriodicalTaskFields | undefined = undefined>(
  config: {
  identity: UUID;
...
): Promise<UpdatePeriodicalTaskResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<UpdatePeriodicalTaskResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
export type DestroyPeriodicalTaskResult = | { success: true; data: {}; }
| { success: false; errors: AshRpcError[]; }

;

export async function destroy_periodical_task(
  config: {
  identity: UUID;
  hookCtx?: ActionHookContext;
  headers?: Record<string, string>;
  ...
  return executeActionRpcRequest<DestroyPeriodicalTaskResult>(
    payload,
    config
  );
}
...
export type CreateTaskTemplateFields = UnifiedFieldSelection<TaskTemplateResourceSchema>[];

export type InferCreateTaskTemplateResult<
  Fields extends CreateTaskTemplateFields | undefined,
> = InferResult<TaskTemplateResourceSchema, Fields>;

export type CreateTaskTemplateResult<Fields extends CreateTaskTemplateFields | undefined = undefined> = | { success: true; data: InferCreateTaskTemplateResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function create_task_template<Fields extends CreateTaskTemplateFields | undefined = undefined>(
  config: {
...
): Promise<CreateTaskTemplateResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<CreateTaskTemplateResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
export type ListTaskTemplatesFields = UnifiedFieldSelection<TaskTemplateResourceSchema>[];


export type InferListTaskTemplatesResult<
  Fields extends ListTaskTemplatesFields | undefined,
  Page extends ListTaskTemplatesConfig["page"] = undefined
> = ConditionalPaginatedResultMixed<Page, Array<InferResult<TaskTemplateResourceSchema, Fields>>, {
  results: Array<InferResult<TaskTemplateResourceSchema, Fields>>;
  has_more: boolean;
  limit: number;
  offset: number;
  count?: number | null;
...
export type ListTaskTemplatesConfig = {
  hookCtx?: ActionHookContext;
  fields: ListTaskTemplatesFields;
  filter?: TaskTemplateFilterInput;
  sort?: string;
  page?: (
    {
      limit?: number;
...
export type ListTaskTemplatesResult<Fields extends ListTaskTemplatesFields, Page extends ListTaskTemplatesConfig["page"] = undefined> = | { success: true; data: InferListTaskTemplatesResult<Fields, Page>; }
| { success: false; errors: AshRpcError[]; }

;

export async function list_task_templates<Fields extends ListTaskTemplatesFields, Config extends ListTaskTemplatesConfig = ListTaskTemplatesConfig>(
  config: Config & { fields: Fields }
): Promise<ListTaskTemplatesResult<Fields, Config["page"]>> {
  const payload = {
    action: "list_task_templates",
    ...(config.fields !== undefined && { fields: config.fields }),
    ...(config.filter && { filter: config.filter }),
    ...(config.sort && { sort: config.sort }),
    ...(config.page && { page: config.page })
  ...
  return executeActionRpcRequest<ListTaskTemplatesResult<Fields, Config["page"]>>(
    payload,
    config
  );
}
...
export type GetTaskTemplateFields = UnifiedFieldSelection<TaskTemplateResourceSchema>[];
export type InferGetTaskTemplateResult<
  Fields extends GetTaskTemplateFields,
> = InferResult<TaskTemplateResourceSchema, Fields>;

export type GetTaskTemplateResult<Fields extends GetTaskTemplateFields> = | { success: true; data: InferGetTaskTemplateResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function get_task_template<Fields extends GetTaskTemplateFields>(
  config: {
  hookCtx?: ActionHookContext;
  fields: Fields;
  headers?: Record<string, string>;
...
): Promise<GetTaskTemplateResult<Fields>> {
  const payload = {
    action: "get_task_template",
    ...(config.fields !== undefined && { fields: config.fields })
  };

  return executeActionRpcRequest<GetTaskTemplateResult<Fields>>(
    payload,
    config
  );
}
...
export type UpdateTaskTemplateFields = UnifiedFieldSelection<TaskTemplateResourceSchema>[];

export type InferUpdateTaskTemplateResult<
  Fields extends UpdateTaskTemplateFields | undefined,
> = InferResult<TaskTemplateResourceSchema, Fields>;

export type UpdateTaskTemplateResult<Fields extends UpdateTaskTemplateFields | undefined = undefined> = | { success: true; data: InferUpdateTaskTemplateResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

export async function update_task_template<Fields extends UpdateTaskTemplateFields | undefined = undefined>(
  config: {
  identity: UUID;
...
): Promise<UpdateTaskTemplateResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<UpdateTaskTemplateResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
export type DestroyTaskTemplateResult = | { success: true; data: {}; }
| { success: false; errors: AshRpcError[]; }

;

export async function destroy_task_template(
  config: {
  identity: UUID;
  hookCtx?: ActionHookContext;
  headers?: Record<string, string>;
...
): Promise<DestroyTaskTemplateResult> {
  const payload = {
    action: "destroy_task_template",
    identity: config.identity
  };

  return executeActionRpcRequest<DestroyTaskTemplateResult>(
    payload,
    config
  );
}

...
echo ""
echo "  2. First-time setup (generates SSL certs + runs migrations):"
echo "     DATABASE_URL=ecto://postgres:postgres@localhost/viban_prod \\"
echo "     SECRET_KEY_BASE=\$(openssl rand -base64 48) \\"
echo "     $RELEASE_DIR/bin/viban eval 'Viban.Release.setup()'"
echo ""
...
echo ""
echo "  4. Open in browser: https://localhost:4000"
echo "     (Accept the self-signed certificate warning)"
echo ""
echo "HTTP/2 is enabled automatically when SSL certs are present."
echo "This solves the Electric sync connection limit issue."

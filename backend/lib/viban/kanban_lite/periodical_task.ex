defmodule Viban.KanbanLite.PeriodicalTask do
  @moduledoc """
  ...
  alias Viban.KanbanLite.PeriodicalTask.Changes
  alias Viban.KanbanLite.PeriodicalTask.Validations
  ...
  relationships do
    ...
    has_many :tasks, Viban.KanbanLite.Task do
      public? true
    end
  end
